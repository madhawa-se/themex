...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
    ...
    <body class="<?php print $body_classes; ?>">
        ...
        <div id="page" class="container">
            ...
            <div id="main-squeeze">
                ...
                <div id="content" class="row">
                    ...
                    <div class="row">
                        <div id="content-content" class="clear-block col-sm-6 intro">
                            <div>
                        ...
                        <?php if (!empty($right_download)): ?>
                            <div id="right-download-region" class="col-sm-6 download">
        ...
        <div class="sss feed-container">
            <div class="container">
                <!-- content bottom -->
                <?php if (!empty($feed_pane)): ?>
                    <div id="feed_pane-region" class="row">
                        <?php print $feed_pane; ?>
                    </div>
                <?php endif; ?>
                <!-- // content bottom -->
